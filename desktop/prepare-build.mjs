...
if(!fs.existsSync(sourceIcon))throw new Error('MyFinHub source icon is missing.');
...
console.log(`MyFinHub desktop backend bundled with ${process.version} (${process.arch}); Windows icon prepared at 512x512.`);
