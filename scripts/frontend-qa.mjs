...
try{
  ...
  const openMobileMore=async()=>{if(!await c.eval(`Boolean(document.querySelector('[aria-labelledby="mobile-more-title"]'))`))await clickLabel('Περισσότερες ενότητες');await waitFor(`Boolean(document.querySelector('[aria-labelledby="mobile-more-title"]'))`,'mobile More dialog');await sleep(220)};
