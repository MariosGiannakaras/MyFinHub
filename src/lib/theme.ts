...
.period-row,.period-control{background:var(--surface-inset)!important;border-color:var(--border-subtle)!important;box-shadow:var(--shadow-inset)!important;color:var(--text-secondary)!important}.period-control>span{background:var(--control-bg)!important;border-color:var(--border-subtle)!important;color:var(--text-secondary)!important;box-shadow:var(--shadow-soft)!important}.period-control button{background:var(--control-gradient)!important;border-color:var(--border-subtle)!important;color:var(--accent)!important;box-shadow:var(--shadow-soft)!important}
.mobile-transaction-filters .filter-label{background:var(--surface-inset)!important;border-color:var(--border-subtle)!important;color:var(--text-secondary)!important;box-shadow:var(--shadow-inset)!important}.mobile-transaction-filters .filter-label>span{color:var(--text-secondary)!important}
.mobile-transaction-row,.mobile-recurring-row{background:var(--surface-elevated-gradient)!important;border-color:var(--border-subtle)!important;box-shadow:var(--shadow-soft)!important;color:var(--ink)!important}.mobile-recurring-meta{background:var(--surface-inset)!important;border-color:var(--border-subtle)!important;box-shadow:var(--shadow-inset)!important}.mobile-transaction-comment,.mobile-transaction-meta,.mobile-history-label{color:var(--text-secondary)!important}.mobile-row-actions{border-color:var(--border-subtle)!important}.mobile-action-menu summary,.mobile-action-menu>div{background:var(--surface-elevated-gradient)!important;border-color:var(--border-subtle)!important;box-shadow:var(--shadow-soft)!important;color:var(--ink)!important}.mobile-action-menu>div button{color:var(--text-secondary)!important}
