...
export const LIGHT_THEME_TOKENS:ThemeTokens={
  ...
  '--ink':'#10234d','--ink-2':'#28416f','--text-primary':'#10234d','--text-secondary':'#516889','--muted':'#70809d','--muted-2':'#95a3ba','--text-disabled':'#8d9bb1','--on-accent':'#ffffff','--white':'#ffffff',
...
.top-actions button,.icon-button,.settings-actions button,.secondary,.row-actions button,.loan-actions button,.review-buttons button,.frequent-strip button,.frequent-grid button,.kind-grid button,.text-size-picker button{background:var(--control-gradient)!important;border-color:var(--border-subtle)!important;color:var(--ink)!important;box-shadow:var(--shadow-soft)!important}
...
.metric-icon,.summary-card>svg,.rec-icon,.kind-grid button>span,.insight-icon.review{background:var(--accent-soft)!important;color:var(--accent)!important}.mini-progress,.loan-progress{background:var(--chart-grid)!important}
