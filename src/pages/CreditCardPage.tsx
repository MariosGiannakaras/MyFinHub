...
export function CreditCardPage({
  ...
  const editLimit=()=>{
    ...
    const numeric=Number(raw.replace(',','.'));if(!Number.isFinite(numeric)||numeric<0){setMessage('Έλεγξε το όριο που έβαλες — χρειάζεται αριθμός ίσος ή μεγαλύτερος από μηδέν.');return}
