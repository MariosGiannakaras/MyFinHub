...
import { ArrowDownRight, ArrowUpRight, CalendarClock, CalendarRange, Eye, EyeOff, PiggyBank, Plus, Sparkles } from 'lucide-react';
...
export function DashboardPage({ data, month, asOf, motionMode='system', onQuickAdd, onTransactions, onPlanning }: {data:FinanceData;month:string;asOf:string;motionMode?:'system'|'reduced'|'full';onQuickAdd:(prefill?:QuickPrefill)=>void;onTransactions:()=>void;onPlanning:()=>void}) {
