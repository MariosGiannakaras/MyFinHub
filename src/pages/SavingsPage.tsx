  ...
  return <div className="page-stack savings-page">
    ...
    <div className="savings-mobile-legacy">
      ...
      <section className="savings-breakdown-grid">
        <article className="panel neo-raised"><div className="panel-head"><div><span>Πηγές αποταμίευσης</span><small>Σύνολο για την επιλεγμένη περίοδο</small></div></div><div className="savings-source-list">{ACTIONS.map(action=><div key={action.source}><span>{action.title}</span><b><AnimatedAmount value={breakdown.bySource[action.source]}/></b></div>)}</article>
