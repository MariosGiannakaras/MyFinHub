...
const part1=readFileSync(new URL('../src/styles/shell-navigation-foundations.css',import.meta.url),'utf8');
const part4=readFileSync(new URL('../src/styles/root-responsive-coordination.css',import.meta.url),'utf8');
